        ...
        <div className="grid grid-cols-5 md:flex md:justify-between items-center h-full w-full">
          ...
          <div className="col-span-1 flex items-center justify-end gap-2">
            ...
            <div className="hidden md:flex items-center space-x-3">
              <button className="text-stone-600 hover:text-boun-blue transition-colors p-1">
                <Search size={18} />
              </button>
              ...
              <div className="relative" ref={dropdownRef}>
                <button 
                  ...
                  className="flex items-center gap-2 bg-stone-800 text-stone-100 px-3 py-1.5 rounded-md text-xs font-sans font-medium hover:bg-stone-700 transition-colors shadow-lg shadow-stone-400/50"
                >
            ...
            <div className="md:hidden flex justify-end">
              <button onClick={() => setIsMenuOpen(!isMenuOpen)} className="text-stone-800 p-1">
