...
import ResourceUploadModal from '../../components/Archive/ResourceUploadModal';
    ...
    return (
        <div className="flex flex-col min-h-full bg-[#f5f5f4] relative">
            ...
            <div className="bg-white border-b border-stone-200 sticky top-0 z-30 shadow-sm">
                <div className="px-4 pt-16 pb-2 md:py-2 flex items-center justify-between">
                    ...
                    <div className="space-y-4">
                        {commissionFilter && (
                            <div className="bg-stone-800 text-white p-4 rounded-lg flex items-center justify-between mb-6 shadow-lg">
                                ...
                                <button onClick={() => navigate('/arsiv')} className="text-xs font-bold underline text-boun-gold">Filtreyi Kaldır</button>
                            </div>
                        )}
