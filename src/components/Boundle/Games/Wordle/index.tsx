...
import { checkDailyWord, calculateScore } from '../../../../lib/games/wordle_service';
...
const WordleGame: React.FC<WordleGameProps> = ({ onClose, isHighContrast }) => {
    ...
    }, [gameState, loading, currentRow, currentCol, grid]);
    ...
    return (
        <div className="flex flex-col h-full w-full">
            ...
            {/* 4. RESULT OVERLAY (Attached at the end) */}
            <AnimatePresence>
                {gameState !== 'playing' && (
                    <ResultOverlay
                        gameState={gameState}
