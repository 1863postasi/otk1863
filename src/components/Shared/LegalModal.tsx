            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed z-50 w-full max-w-2xl bg-[#fcfbf9] rounded-xl shadow-2xl border border-stone-200 overflow-hidden max-h-[85vh] flex flex-col"
                        // Start centered
                        style={{
                            top: '50%',
                            left: '50%',
                            transform: 'translate(-50%, -50%)',
                            marginTop: '-20px' // Slight offset for visual balance
                        }}
                    >
                        {/* Header */}
