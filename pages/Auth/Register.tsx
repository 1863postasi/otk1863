      ...
      >
        ...
        <div className="p-8">
          ...
          <form onSubmit={handleRegister} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                <input 
                  ...
                  className={`w-full pl-10 pr-4 py-3 bg-stone-50 border rounded text-stone-900 outline-none text-sm transition-colors ${
              ...
              <div>
                ...
                <div className="relative">
                  <input 
                    ...
                    onChange={handleChange}
                    className={`w-full pl-9 pr-3 py-3 bg-stone-50 border rounded text-stone-900 focus:ring-2 outline-none text-sm ${
                        formData.passwordConfirm && formData.password !== formData.passwordConfirm ? 'border-red-300 focus:ring-red-200' : 'border-stone-200 focus:ring-stone-800'
                    }`}
                    placeholder="••••••"
                    required
                  />
            ...
            >
              {loading ? <Loader2 size={18} className="animate-spin" /> : 'Kayıt Ol'}
            </button>
          </form>

          <div className="mt-6 text-center text-sm text-stone-600">
            Zaten hesabınız var mı? <Link to="/auth/login" className="font-bold text-boun-blue hover:underline">Giriş Yapın</Link>
          </div>
        </div>
      </motion.div>
    </div>
