...
const wordListData = __importStar(require("../data/wordList"));
...
exports.checkDailyWord = functions.https.onCall(async (data, context) => {
    ...
    // 6. Save to Firestore
    await gameRef.set(Object.assign({ guesses: admin.firestore.FieldValue.arrayUnion(normalizedGuess), status: status, lastUpdated: admin.firestore.FieldValue.serverTimestamp() }, (isWin ? { score } : {})), { merge: true });
